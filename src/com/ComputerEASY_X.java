...
public class ComputerEASY_X implements ActionListener, MouseListener {
    ...
    ComputerEASY_X() {
        ...
        this.diffPanel.setBounds(120, 35, 250, 50);     
            ...
            this.diffButton[0].setFont(new Font("Arial", 1, 24));
        ...
        this.diffButton[0].setText("CHƠI VỚI MÁY DỄ");
